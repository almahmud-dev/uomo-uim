// ============================================================
// ShopMegaMenu.jsx
// Desktop Navbar এ "SHOP" hover করলে যে বড় mega menu
// দেখায়। Categories columns + right side featured image।
// ============================================================
        ...
        <div className="border-t border-footer pt-10 pb-11 grid grid-cols-12">
          ...
          <div className="col-span-9 grid grid-cols-6">
            ...
            <div>
              {[0, 1].map((i) => (
                <div key={i} className={i === 1 ? "mt-7.25" : ""}>
                  <p className="texts_14_medium text-second pb-3">{megaMenuData[i]?.title}</p>
                  <ul>
            ...
            <div className="col-span-2 flex justify-center">
              <div>
                <p className="texts_14_medium text-second pb-3">{megaMenuData[2]?.title}</p>
                <ul>
            ...
            <div className="col-span-3 grid grid-cols-2">
              <div className="flex justify-center">
                <div>
                  <p className="texts_14_medium text-second pb-3">{megaMenuData[3]?.title}</p>
                  <ul>
          ...
          <div className="col-span-3 relative">
            <Images imgAlt="navdropDownImage" imgSrc={NavDownImg} className="w-102.5 h-112.5 object-cover" />
            <div className="absolute bottom-7.5 left-7.5">
              <h4 className="text-[28px] font-medium text-head">NEW <br /> HORIZONS</h4>
              <Button
                btnText="SHOP NOW"
