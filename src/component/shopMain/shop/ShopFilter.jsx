  ...
  return (
    <>
      <section>
        ...
        <div
          className={`fixed top-0 right-0 h-full w-105 bg-white shadow-lg overflow-y-auto z-50 transition-transform duration-300 ${isOpen ? "translate-x-0" : "translate-x-full"}`}
        >
          ...
          <div className="pl-10 pt-9.5 pr-10 pb-4 mb-4">
            ...
            >
              Color
              <span>
                {open === "colors" ? <IoIosArrowUp /> : <IoIosArrowDown />}
              </span>
            </button>
          ...
          <div className="pl-10 pt-9.5 pr-10 pb-4 mb-4">
            ...
            >
              Sizes
              <span>
                {open === "sizes" ? <IoIosArrowUp /> : <IoIosArrowDown />}
              </span>
            </button>
          ...
          <div className="pl-10 pt-9.5 pr-10 pb-4 mb-4">
            ...
            >
              Brands
              <span>
                {open === "brands" ? <IoIosArrowUp /> : <IoIosArrowDown />}
              </span>
            </button>
